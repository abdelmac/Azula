...
- Sessions HttpOnly et CSRF ; permissions vérifiées au serveur. Aucun secret dans Git. Déploiement Internet autorisé par l’utilisateur, sur l’hébergement choisi pour Azula ; conserver les données et secrets locaux séparés.
